...
public class IndexController {
	...
	public List<Usuario> poblarUsuarios(){
		List<Usuario> usuarios = Arrays.asList(
				new Usuario("Juan","Morales","juan@email.com"),
				new Usuario("Ramón","Morales","ramon@email.com"),
				new Usuario("María","Martínez","maria@email.com"),
				new Usuario("Yazmin","Morales","yazmin@email.com")
				);
		return usuarios;
	}
